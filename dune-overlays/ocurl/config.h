...
/* Define to 1 if you have the declaration of `CURLINFO_ACTIVESOCKET', and to
   0 if you don't. */
#define HAVE_DECL_CURLINFO_ACTIVESOCKET 1

/* Define to 1 if you have the declaration of `CURLINFO_CERTINFO', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `CURLINFO_HTTP_VERSION', and to
   0 if you don't. */
#define HAVE_DECL_CURLINFO_HTTP_VERSION 1
...
/* Define to 1 if you have the declaration of `CURLMOPT_MAXCONNECTS', and to 0
   if you don't. */
#define HAVE_DECL_CURLMOPT_MAXCONNECTS 1

/* Define to 1 if you have the declaration of `CURLMOPT_MAX_HOST_CONNECTIONS',
   and to 0 if you don't. */
#define HAVE_DECL_CURLMOPT_MAX_HOST_CONNECTIONS 1

/* Define to 1 if you have the declaration of `CURLMOPT_MAX_PIPELINE_LENGTH',
   and to 0 if you don't. */
#define HAVE_DECL_CURLMOPT_MAX_PIPELINE_LENGTH 1

/* Define to 1 if you have the declaration of
   `CURLMOPT_MAX_TOTAL_CONNECTIONS', and to 0 if you don't. */
#define HAVE_DECL_CURLMOPT_MAX_TOTAL_CONNECTIONS 1

/* Define to 1 if you have the declaration of `CURLMOPT_PIPELINING', and to 0
   if you don't. */
#define HAVE_DECL_CURLMOPT_PIPELINING 1

/* Define to 1 if you have the declaration of `CURLMOPT_SOCKETDATA', and to 0
   if you don't. */
#define HAVE_DECL_CURLMOPT_SOCKETDATA 1

/* Define to 1 if you have the declaration of `CURLMOPT_SOCKETFUNCTION', and
   to 0 if you don't. */
#define HAVE_DECL_CURLMOPT_SOCKETFUNCTION 1

/* Define to 1 if you have the declaration of `CURLMOPT_TIMERDATA', and to 0
   if you don't. */
#define HAVE_DECL_CURLMOPT_TIMERDATA 1

/* Define to 1 if you have the declaration of `CURLMOPT_TIMERFUNCTION', and to
   0 if you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_CERTINFO', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_CONNECT_TO', and to 0
   if you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_DOH_URL', and to 0 if
   you don't. */
#define HAVE_DECL_CURLOPT_DOH_URL 1
...
/* Define to 1 if you have the declaration of `CURLOPT_LOGIN_OPTIONS', and to
   0 if you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_MAIL_RCPT', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_MIMEPOST', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_PASSWORD', and to 0 if
   you don't. */
#define HAVE_DECL_CURLOPT_PASSWORD 1

/* Define to 1 if you have the declaration of `CURLOPT_PIPEWAIT', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_POSTREDIR', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_SSL_OPTIONS', and to 0
   if you don't. */
#define HAVE_DECL_CURLOPT_SSL_OPTIONS 1
...
/* Define to 1 if you have the declaration of `CURLOPT_TCP_FASTOPEN', and to 0
   if you don't. */
#define HAVE_DECL_CURLOPT_TCP_FASTOPEN 1
...
/* Define to 1 if you have the declaration of `CURLOPT_USERNAME', and to 0 if
   you don't. */
...
/* Define to 1 if you have the declaration of `CURLOPT_XFERINFOFUNCTION', and
   to 0 if you don't. */
#define HAVE_DECL_CURLOPT_XFERINFOFUNCTION 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_BEARSSL', and to
   0 if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_BEARSSL 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_GNUTLS', and to
   0 if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_GNUTLS 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_GSKIT', and to 0
   if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_GSKIT 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_MBEDTLS', and to
   0 if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_MBEDTLS 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_MESALINK', and
   to 0 if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_MESALINK 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_NONE', and to 0
   if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_NONE 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_NSS', and to 0
   if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_NSS 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_OPENSSL', and to
   0 if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_OPENSSL 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_SCHANNEL', and
   to 0 if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_SCHANNEL 1

/* Define to 1 if you have the declaration of
   `CURLSSLBACKEND_SECURETRANSPORT', and to 0 if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_SECURETRANSPORT 1

/* Define to 1 if you have the declaration of `CURLSSLBACKEND_WOLFSSL', and to
   0 if you don't. */
#define HAVE_DECL_CURLSSLBACKEND_WOLFSSL 1

/* Define to 1 if you have the declaration of `CURL_HTTP_VERSION_2', and to 0
   if you don't. */
#define HAVE_DECL_CURL_HTTP_VERSION_2 1

/* Define to 1 if you have the declaration of `CURL_HTTP_VERSION_2TLS', and to
   0 if you don't. */
#define HAVE_DECL_CURL_HTTP_VERSION_2TLS 1

/* Define to 1 if you have the declaration of `CURL_HTTP_VERSION_2_0', and to
   0 if you don't. */
...
/* Define to 1 if you have the declaration of `curl_multi_poll', and to 0 if
   you don't. */
#define HAVE_DECL_CURL_MULTI_POLL 1
...
#define PACKAGE_NAME "ocurl"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ocurl 0.9.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ocurl"
